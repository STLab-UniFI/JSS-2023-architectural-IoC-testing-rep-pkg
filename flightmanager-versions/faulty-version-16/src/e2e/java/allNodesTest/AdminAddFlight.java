	...
	public void test1() {
		...
		Warp.initiate(new Activity() {
			...
			public void perform() {
				...
				addFlights = new AddFlights(driver);
				addFlights.insertFlightInfo(flightNumber, departureDate, departureTime, duration, passengers,
						pricePerPerson, origin, destination);
		...
		Warp.initiate(new Activity() {
			...
			public void checkNewAiportId() {
				assertNull(flightController.getFlight().getId());
			}
		});
