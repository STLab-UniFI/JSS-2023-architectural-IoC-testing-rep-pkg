# Flight Manager Faulty Version #28

This is the _Flight Manager_ faulty version #28 involving the book flight use case.
The fault injected is of _wrongConformance_ type causing a _Zombie Component_ failure mode and it is represented graphically in the _Enriched Robustness Diagrams_ below.
...
<p align="center">
  <img src="../../imgs/faulty-versions/28/err-28-visitor-book-flight-erd.png?raw=true" style="width:90%">
</p>
...
<p align="center">
  <img src="../../imgs/faulty-versions/28/err-28-visitor-search-book-flight-erd.png?raw=true" style="width:100%">
</p>
